                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1">
                        {coupon.regions.length >= 7 ? (
                          <span className="inline-block px-1.5 py-0.5 text-[10px] uppercase tracking-wider font-semibold border border-ink/15 text-ink-muted">
                            Global
                          </span>
                        ) : (
                  ...
                  {expiredCoupons.map((coupon, i) => (
                    <tr key={coupon.code} className="border-b border-ink/8 last:border-b-0 opacity-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-wrap gap-1">
                          {coupon.regions.length >= 7 ? (
                            <span className="inline-block px-1.5 py-0.5 text-[10px] uppercase tracking-wider font-semibold border border-ink/10 text-ink-muted">
                              Global
                            </span>
                          ) : (
                            coupon.regions.map((r) => (
