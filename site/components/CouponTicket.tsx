...
export default function CouponTicket({ code, label, sublabel }: CouponTicketProps) {
  ...
  return (
    <button
      ...
      className="
        coupon-ticket w-full text-left
    ...
    >
      <div>
        ...
        <p
          className="font-editorial text-4xl md:text-5xl font-bold tracking-widest text-ink group-hover:text-cream transition-colors duration-200"
      ...
      <div className="flex-shrink-0 text-xs font-semibold uppercase tracking-widest flex flex-col items-center gap-1">
        {copied ? (
          <>
            <svg className="w-5 h-5 text-signal" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true">
          ...
          <>
            <svg className="w-5 h-5 text-ink-muted group-hover:text-cream transition-colors duration-200" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
